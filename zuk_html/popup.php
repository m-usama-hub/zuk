                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">
                              ...
                              <i class="far fa-user"></i>My Account</h5>
                          <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                        </div>
...
<div class="row">
    ...
    <div class="post_a_house_mate_detail">
        <div class="person">
                ...
                <div class="profile"><h5>Profile photo</h5></div>
        </div>
...
<div class="row ">
    <div class="col-md-6 col-12  imp_dates">
        ...
        <div class="col-md-12 col-12 free"><p>Available now</p>
    ...
    <div class="switch_in_flex">
        <div class="switches"><p>Profile photo</p>
            <div class= "switch_div">
                <label class="switch">
                    <input type="checkbox">
                    <span class="slider round"></span>
        ...
        <div class="c switches"><p>Private phone</p>
            <div class=" switch_div">
                <label class="switch">
                    <input type="checkbox">
                    <span class="slider round"></span>
