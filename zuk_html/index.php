            ...
            <div class="row">
               ...
               <div class="swiper-container new_update_slider" data-aos="fade-up" data-aos-duration="1500">
                  <div class="swiper-wrapper">
                     ...
                     <div class="swiper-slide"><div class="col-md-3 swp-shadow">
                           <h2>14</h2>
                           <p>APRIL</p>
                        </div>
                        <div class="col-md-9 swp-icons">
               ...
               <div class="col-lg-12">
                  <nav>
                     <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-link  active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile1" role="tab" aria-controls="nav-profile" aria-selected="false">For Sale</a>
                              ...
                              <div class="card">
                                ...
                                <div class="col-md-12 card-in-heart">
                                 ...
                                 <div class="col-md-12 card-footer">
                                    ...
                                    <!--   View Profile-->
                                    <!--</button>-->
                                   <a href="./professional_detail.php"></a>
                                   <div class="ab-right">
                                    <a href="#!"><i class="fas fa-phone-alt"></i></a>
                                    <a href="#!"><i class="far fa-envelope"></i></a>
                                   </div>
        ...
        <div class="swiper-slide">
             <div class="item_sale_card" data-aos="fade-up" data-aos-duration="1500">
                              <div class="card">
                                 ...
                                 <a href="./buy_sell_items.php"><img class="card-img-top" src="./img/sofa2.png" alt="Card image cap"></a>
                                 <div class="card-body">
                                       <div class="rating_buy_sell">
                                         <span><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                                     </div>
                                    <a href="./buy_sell_items.php"><h4 class="card-title blue"><small> Leather Classic Sofa Set <i class="fas fa-check green"></i></small></h4></a>
                                    <p class="card-text orange d-flex align-items-center"><b>$500</b> <span class="sm-size">Only 3 Left</span></p>
                                    <p class="pb-3 gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                                 </div>
                                 <div class="col-md-12 d-flex align-items-center pb-2 card-footer">
         ...
         <div class="container custom_container">
            <div class="row">
               <div class="col-lg-12 text-center pb-4">
                  <p class="blue" data-aos="fade-right" data-aos-duration="1500">Check Video Presentation To Find Out More About Us</p>
                  <h2 class="blue" data-aos="fade-left" data-aos-duration="1500">Why Use Homzs? </h2>
                  <a class="btn btn-play" type="button" class="btn img-video-btn" data-toggle="modal" data-target="#exampleModal"> <i class="fas fa-play"></i> </a>
               </div>
               <div class="col-lg-4" data-aos="zoom-in" data-aos-duration="1500">
                  <div class="media">
                     <img class="mr-4" src="./img/icon1.png" alt="Generic placeholder image" width="70px" height="70px">
                     <div class="media-body">
                        <h5 class="mt-0 blue">24 Hours Support</h5>
                        <p class="gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4" data-aos="zoom-in" data-aos-duration="1500">
                  <div class="media">
                     <img class="mr-4" src="./img/icon2.png" alt="Generic placeholder image" width="70px" height="70px">
                     <div class="media-body">
