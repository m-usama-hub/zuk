    ...
    <div class="container-fluid">
        <div class="card white-box">
            <div class="card-body">
                ...
                <hr />
                <form class="m-t-20" method="POST" action="{{ route('add_translation') }}" novalidate
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="en" value="{{ old('en') }}" class="form-control" required
                                    data-validation-required-message="en is required" autofocus>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="email" name="fr" value="{{ old('fr') }}" class="form-control" required
                                    data-validation-required-message="fr field is required">
                                ...
                                @foreach ($lines as $k => $role)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            <a href="{{ route('edit_show', $role->id) }}" class="btn btn-warning zoomer"
                                                data-toggle="tooltip" data-original-title="Edit"> <i
                                                    class="fa fa-pencil text-white m-r-10"></i>
                                                Edit </a>
                                        </td>
