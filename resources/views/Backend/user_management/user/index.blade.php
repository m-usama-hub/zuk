...
@section('content')
    ...
    @can('user-create')
        ...
        @include('Backend.layouts.partials.breadcumb',['data' => ['Users'],'button'=>['display' =>
        true,'link'=>'user.create','parameters' => null,'text'=>'Add New User']])
                                            ...
                                            <td class="text-nowrap" align="center">
                                                ...
                                                @can('seller-profile-view')
                                                    @if (!empty($user->seller))
                                                        <a class="zoomer"
                                                            href="{{ route('seller.profile', !empty($user->seller) ? $user->seller->id : 0) }}"
                                                            data-toggle="tooltip" data-original-title="View Profile"
                                                            title="View Profile" style="padding:5px 5px;">
