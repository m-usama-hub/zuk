...
@section('content')
    ...
    <!-- Start Page Content -->
    <!-- ============================================================== -->
    @include('Backend.layouts.partials.breadcumb',['data' => ['Business Properties'],'button'=>['display' => false]])
                                ...
                                @foreach ($records as $k => $role)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            @can('business-properties-view')
                                                <a href="{{ route('properties.show', $role->id) }}"
                                            ...
                                            @can('business-properties-delete')
                                                ...
                                                <form id="delete-form-{{ $role->id }}"
                                                    action="{{ route('properties.destroy', $role->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf @method('delete')
                                                </form>
                                            @endcan
