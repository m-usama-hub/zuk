...
@section('content')
    ...
    <!-- Start Page Content -->
    <!-- ============================================================== -->
    @include('Backend.layouts.partials.breadcumb',['data' => ['Business Projects'],'button'=>['display' => false]])
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            @can('business-projects-delete')
                                                ...
                                                <form id="delete-form-{{ $role->id }}"
                                                    action="{{ route('projects.destroy', $role->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf @method('delete')
                                                </form>
                                            @endcan
