...
@section('content')
    ...
    <!-- Start Page Content -->
    <!-- ============================================================== -->
    @include('Backend.layouts.partials.breadcumb',['data' => ['Business Messages'],'button'=>['display' => false]])

    <div class="container-fluid">
        <div class="card white-box">
            <div class="card-body">
                <h2>Business Messages</h2>
                <!-- Data Table -->
                                        ...
                                        <td class="text-nowrap">
                                            ...
                                            @can('business-messages-delete')
                                                ...
                                                <form id="delete-form-{{ $role->id }}"
                                                    action="{{ route('messages.destroy', $role->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf @method('delete')
                                                </form>
                                            @endcan
