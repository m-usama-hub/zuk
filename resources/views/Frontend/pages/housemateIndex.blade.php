                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            @foreach ($housemates['all'] as $key => $housemate)
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="card" data-link="{{ $housemate->link }}"
                                                        ...
                                                        <div class="col-md-12 card-in-heart">
                                                            ...
                                                            $housemate->id, 'title' => $housemate->title, 'modal' =>
                                                            'Housemate','user' =>
                                                        ...
                                                        <a href="{{ $housemate->link }}" class="anchor_img"><img
                                                                class="card-img-top"
                                                        ...
                                                        <div class="card-body">
                                                            <h4 class="card-title blue">
                                                                <small> <a
                                                                        href="{{ route('HousemateDetail', $housemate->slug) }}">{{ $housemate->title }}</a>
                                                                </small>
                                                            </h4>
                                                            ...
                                                            <div class="row no-gutters">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="view_profile">
                                                                        <a href="{{ route('HousemateDetail', $housemate->slug) }}"
                                                                            class="btn">View
                                                                            Profile</a>
                                                                    </div>
                                                                </div>
