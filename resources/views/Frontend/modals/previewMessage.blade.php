                        ...
                        <div class="col-lg-12 detail-box">
                            <div class="row">
                                    ...
                                    <div class="gr_photos">
                                        <div
                                            ...
                                            <div class="swiper-button-prev swiper-button-disabled" tabindex="-1"
                                                role="button" aria-label="undefined" aria-controls="Previous slide"
                                ...
                                <div class="col-lg-8 media_content">
                                    <div class="media">
                                        <img class="mr-3"
                                            src="{{ asset(Auth::user()->UserDetail->profile_pic) }}" width="100"
                                            alt="Generic placeholder image">
                                        <div class="media-body">
                                            <h3 class="mt-0 blue title">Parents Support Group Meeting<span
                                                    class="ab-right"><i
                                                        class="far fa-calendar-alt"></i>{{ date('d M Y') }}</span>
                                            </h3>
                                            <ul class="single_room_details">
                                                <li class="gray">{{ Auth::user()->UserDetail->fullname }}
                                                </li>
                                                <li class="gray"> {{ Auth::user()->UserDetail->address }}
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="pr-description">
                                        ...
                                        <p class="addReadMore showlesscontent message">that I hired the above service
                                            provider
                                            and that
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-12">
                                            <div class="contact-desc">
                                                <ul>
                                                    <li> <a
                                                            href="tel: {{ Auth::user()->UserBusinessDetail->business_phone ?? '' }}"><i
