<div class="modal fade" id="previewProperty" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
       ...
       <div class="modal-content find_property_pop_up">
          <div class="modal-body d-flex">
             ...
             <div class="col-lg-8 media_content">
                <div class="media">
                   <img class="mr-3" src="{{ asset(Auth::user()->UserBusinessDetail->BusinessUser->profile_pic) }}" width="100" alt="Generic placeholder image">
                   <div class="media-body">
                      <h3 class="mt-0 blue"> <span class="property_beds">2 Bedroom</span> <span class="property_type">Basement Flat</span><span class="ab-right sale_price">$250,000.00</span></h3>
                      <p class="gray address">Vanguard Drive, Etobicoke ON M9B 5E7 <span class="ab-right for_type">For Sale</span></p>
                   </div>
                </div>
                <div class="pr-description">
                   <ul class="smart_realtor">
                      ...
                      <li><i class="fas fa-bed pr-2 l-blue icons-p"></i> <span  class="property_beds">3</span> </li>
                      <li><i class="pl-2 pr-2 fas fa-bath l-blue"></i> <span class="property_baths">1</span> </li>
                      <li><i class="pl-2 fas fa-cube l-blue"></i> <span class="property_type">Flat/Apartment</span> </li>
                   </ul>
                   ...
                   <p class="addReadMore showlesscontent other_info">that I hired the above service provider and that
                      this review is based on my personal experience of the service I received and is my
                      honest opinion of this company or person. I have not received any additional
                      benefits or rewards f I hired the above service provider and that this review is
                      based on my personal experience of the service I received and is my honest opinion
                ...
                <div class="contact-desc0 pb-3">
                   <a href="#"><i class="fas fa-user-alt l-blue"></i> Contact person | {{ Auth::user()->UserBusinessDetail->BusinessUser->fullname }}</a>
                </div>
                <div class="contact-desc">
                   <a href="tel: {{ Auth::user()->UserBusinessDetail->business_phone }}"><i class="fas fa-phone-alt l-blue pr-2"></i> {{ Auth::user()->UserBusinessDetail->business_phone }}</a> <a href="mailto:{{ Auth::user()->UserDetail->email }}"><i class="fas fa-envelope l-blue pl-2 pr-2"></i> {{ Auth::user()->UserDetail->email }}</a>
