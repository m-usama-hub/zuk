    ...
    <div class="container custom_container">
        <div class="row">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12 col-12">
                                    <img src="Frontend/img/paypal.png" alt="" class="img-fluid size">
                                    <img src="Frontend/img/Group 291.png" alt="" class="img-fluid visa">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade admin_abuse_popup " id="adminabuse" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade delete_account_popup" id="deleteaccount" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-trash"></i>Delete
                                    account</h5>
                                <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="col-md-12 col-12">
                                    <p>Do you want us to permanently delete your usage data from our Homzs servers?
                                        By selecting this option, you cannot restore your history when you return to
                                        Homzs.</p>
                                </div>
                                <div class="col-md-12 col-12">
                                    <form action="">
                                ...
                                <div class="col-md-12 col-12">
                                    <form action="" method="POST">
                                        <input type="password" placeholder="Enter password to confirm request"
                                            id="pass">
                                    </form>
                                </div>
                                <div class="col-md-12 col-12">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="notification">
                                    <p>Email notification sent to confirm a message has been received. When the user
                                        clicks
                                        on the "Reply now" link, the message box will open up on Homzs website to
                                        allow the
                                        user to respond to the message. If the user is not logged on to their
                                        account on the
                                ...
                                <div class="email_title">
                                    ...
                                    <p class="subject"> - RE: Zuk replied to your ad: Wooden bed frame with
                                        4 storage boxes
                                    </p>
                                </div>
                                <div class="seller">
                                ...
                                <div class="notification">
                                    <p>This message has been sent through Homzs mail, which keeps your email address
                                        private. We recommend that you always reply via <a href="#!"
                                            class="sent">Homzs
                                            messenger</a> instead of private email addresses. If there is anything
                                        about the
                                        message that you think is suspicious, do not reply and make sure to <a href="#!"
                                            class="sent">report it to us.</a> We want to look out
                                        for you so we look into
                                        all reports and get back to you asap.
                                    </p>
                                </div>
                                <div class="safety_tips">
                                    <h3>To make sure you have the best experience with us, here are a few top safety
                                        tips when
                                ...
                                <div>
                                    <ul class="buy_selling">
                                        <li>Try to share photos and ask lots of questions about the items you are
                                            buying and
                                        ...
                                        <li>Use the PayPal 'Paying for an item or service' option to transfer money
                                            securely. This is the only option covered by <a href="#!"
                                                class="sent"> PayPal's
                                                Buyer Protection</a> policy.
                                        </li>
                                        <li>If you're a seller, log into your PayPal account to ensure you have
                                            received
                                            payment. Never trust an email confirmation telling you so without
                                            verification.
                                        </li>
                                        <li>Be wary of links sent by other users that direct you to login to Homzs.
                                            You
                                            should always access your account via the <a href="#!"
                                                class="sent">Homzs
                                                homepage</a>
                                        </li>
                                    </ul>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade my_details_popup show" id="mydetails" tabindex="-1"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-12 personal_box">
                                            ...
                                            <div class="personal">
                                                <div class="edit_profile person_edit_photo">
                                                    <img src="Frontend/img/Group410.png" alt="" class="img-fluid  ">
                                                </div>
                                        ...
                                        <div class="col-md-4 col-12 personal_box2">
                                                ...
                                                <div
                                                    ...
                                                    <div class="swiper-wrapper" id="swiper-wrapper-2af7103c3e0421064d"
                                                        ...
                                                        <div class="swiper-slide swiper-slide-active"
                                                            style="width: 139px;">
                                                            <img src="Frontend/img/Group413.png" alt=""
                                                                class="pr_photo">
                                                    ...
                                                    <div class="swiper-button-next" tabindex="0" role="button"
                                                        aria-label="undefined" aria-controls="Next slide"
                                                        aria-disabled="false"></div>
                                                    <div class="swiper-button-prev swiper-button-disabled"
                                                        tabindex="-1" role="button" aria-label="undefined"
                                                        aria-controls="Previous slide" aria-disabled="true"></div>
                                                    <div
                                            ...
                                            <div class="gr_photos">
                                                <div
                                                    class="swiper modalSwiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                                    <div class="swiper-wrapper" id="swiper-wrapper-8fa79c7f109e07be9"
                                                        aria-live="polite"
                                                        style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                                        <div class="swiper-slide swiper-slide-active"
                                                            style="width: 139px;">
                                                            ...
                                                            <div class="camera"><i class="fas fa-video"></i>
                                                            </div>
                                                        </div>
                                                        <div class="swiper-slide swiper-slide-next"
                                                            style="width: 139px;">
                                            ...
                                            <div class="form">
                                                ...
                                                Home Decorating">
                                                    ...
                                                    <input type="text" class="p_textarea"
                                        ...
                                        <div class="col-md-4 col-12 personal_box3">
                                            ...
                                            <div class="personal">
                                                <div class="edit_profile3 person_edit_photo">
                                                    <img src="Frontend/img/buisness.png" alt="" class="img-fluid ">
                                                </div>
                                            </div>
                                            <div class="photo_heading">
                                                <h4>Profile photos</h4>
                                            ...
                                            <div class="gr_photos">
                                                <div
                                                    class="swiper modalSwiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                                    <div class="swiper-wrapper" id="swiper-wrapper-030becf1010c7a5e07"
                                                        aria-live="polite"
                                                        style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                                        <div class="swiper-slide swiper-slide-active"
                                                            style="width: 139px;">
                                            ...
                                            <div class=" gr_photos">
                                                <div
                                                    class="swiper modalSwiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                                    <div class="swiper-wrapper" id="swiper-wrapper-a58fa5f53daf13fb"
                                                        aria-live="polite"
                                                        style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                                        <div class="swiper-slide swiper-slide-active"
                                                            style="width: 139px;">
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade my_post_popup" id="mypost" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="col-lg-12 detail-box mt-3">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <img src="Frontend/img/buy_sell_details.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-lg-8 media_content">
                                            <div class="media">
                                                <img class="mr-2" src="Frontend/img/modal_thumbnail.png"
                                            ...
                                            <div class="pr-description">
                                                ...
                                                <p class="addReadMore showlesscontent">that I hired the above
                                                    service provider and that this review is based on my personal
                                                    experience of the service I received and is my honest opinion of
                                                    this company or person. I have not received any additional
                                                    benefits or rewards for</span><span class="readMore"
                                                        title="Click to Show More"> Read More</span><span
                                                        class="readLess" title="Click to Show Less"> Read
                                                        Less</span></p>
                                                <div class="col-md-12 card-in-heart">
                                                    ...
                                                    <a href="#!" class="share mt-2"><i
                                                            class="far fa-edit"></i></a>
                                                </div>
                                            </div>
                                            <div class="contact-desc">
                                                <a href="tel: 647 985 5214"><i
                                                        class="fas fa-phone-alt l-blue pr-2"></i> 647 985 5214</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="col-md-12 col-12">
                                    <p>By signing in with Homzs you agree to our <a href="#!"
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade welcome_popup" id="welcome" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="terms_condition">
                                    <p>By signing in with Homzs you agree to our <a href="#!"
                                            class="terms">Terms of Use</a> and <a href="#!"
                                            class="terms"> Privacy Policy.</a></p>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade my_account_popup" id="myaccount" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body display">
                                ...
                                <div class="col-md-12 col-12 custom_row">
                                    ...
                                    <div class="col-md-4 col-12 box">
                                        <h4 class="head">My privacy<img src="Frontend/img/insurance.png"
                                                class="img-fluid"></h4>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade item_sell_popup" id="itemtosell" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit "></i>Post
                                    an Item to Sell</h5>
                                <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-12 person">
                                        <img src="Frontend/img/person.png" alt="" class="person">
                                        <div class="profile">
                                            <h5>Profile photo</h5>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group text_fields">
                                                    <form>
                                                        <input type="number" placeholder="Private Phone"
                                                            class="text">
                                ...
                                <div class="form-group text_fields">
                                    <input type="text" placeholder="Add item location e.g. Brampton On"
                                        class="text">
                                </div>
                                <div class="price ">
                                    <div class="row">
                                ...
                                <div class="form-group text_fields">
                                    ...
                                    <input type="text" placeholder="Add your item name e.g. Samsung 60 Inches 4K HDTV"
                                        class="text">
                                </div>
                                <div class="form-group">
                                    <div class=" text_fields">
                                        ...
                                        <div class="text_field">
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group ">
                                                        <input type="text" placeholder="Add a link to your website "
                                                            class="text">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="light_text">
                                        <p>Your item will appear on top of search result listing for the duration of
                                            the number of days you have selected.</p>
                                    </div>

                                    <div class="col-md-12 col-12" style="padding:0px;">
                                        <textarea id="item-description" class="description" name="w3review" rows="6"
                                    ...
                                    <div class="col-md-12 col-12 cover_photo">
                                        <div class="img_background">
                                            ...
                                            <div class="trash"><i class="upload_icons fas fa-trash"></i>
                                            </div>
                                            <div class="upload"><i
                                                    class="upload_icons fas fa-file-upload"></i></div>
                                            <div class="camera"><i class="upload_icons fas fa-camera"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12 policy">
                                        <p>By posting this ad with Homzs you agree to our <a href="#!"
                                                class="terms">Terms of Use</a> and <a href="#!"
                                                class="terms">Privacy Policy.</a></p>
                                        <a href="#!"></a>
                                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade messageper" id="personal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <img src="Frontend/img/person.png" alt="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12 text_section">
                                            ...
                                            <div class=" col-md-12 col-12 type_area">
                                                ...
                                                <textarea id="wreview" name="wreview" class="text" rows="4"
                                                    cols="50"></textarea>
                                            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade house_mate_pop" id="posthousemate" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">

                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit "></i>Post a
                                    Housemate</h5>
                                <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="post_a_house_mate_detail">
                                            <div class="person">
                                                <img src="Frontend/img/person_new.png" alt="" class="img-fluid">
                                                <div class="profile">
                                                    <h5>Profile photo</h5>
                                                </div>
                                            </div>
                                            <div class="personal_info">
                                                <div class="form-group text_fields">
                                                    ...
                                                    <input type="number" placeholder="Phone" class="text">
                                                    <input type="email" placeholder="Email Address"
                                                        class="text">
                                                </div>
                                            </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-12 col-12 text-area-custom">
                                        <textarea id="wreview" name="wreview" rows="6" cols="50" class="description"
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade rateme" id="rateme" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-star"></i>Rate
                                    me</h5>
                                <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="col-md-12 col-12 confirm ">
                                    <p class="note"><b>I hereby confirm</b> that I hired the above
                                        service provider and that this review is based on my personal experience of
                                        the service that I received and is my honest opinion of this company or
                                        person. I have not received any additional benefits or rewards for providing
                                        this review.
                                    </p>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="text_fields custom-text-fields">
                                    <input type="text"
                                        placeholder="Add your message tittle e.g. landscaping group for beginners"
                                        class="text">
                                </div>
                                ...
                                <div class="col-md-12 col-12 custom-text-area">
                                    <textarea name="" class="description" cols="30" rows="10"
                                ...
                                <div class="col-md-12 col-12 cover_photo">
                                    <div class="img_background">
                                        ...
                                        <div class="upload"><i class="upload_icons fas fa-file-upload"></i>
                                        </div>
                                        <div class="camera"><i class="upload_icons fas fa-camera"></i>
                                        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade item_sell_popup show" id="postproject" tabindex="-1"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-12 person">
                                        <img src="Frontend/img/person_new.png" alt="" class="person">
                                        <div class="profile">
                                            <h5>Profile photo</h5>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="form-group text_fields">
                                                    <form>
                                                        ...
                                                        <input type="email" placeholder="Email Address"
                                                            class="text">
                                                        <input type="email"
                                                            placeholder="Add project location e.g. Brampton On"
                                                            class="text">
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-12" style="padding:0px;">
                                        <textarea id="item-description" class="description" name="w3review"
                                            rows="6" cols="50" placeholder="Add your item description"></textarea>
                                    </div>
                                    <div class="col-md-12 col-12 cover_photo">
                                        <div class="img_background">
                                            <div class="cover">
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade property" id="private_property" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                            ...
                                            <div class="row forms">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form action="">
                                                        ...
                                                        <div class="form-group text_fields">
                                                            <input type="number" placeholder="Contact person"
                                                                class="text">
                                                        </div>
                                    ...
                                    <div class="row address">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputPassword" class="col-md-7 col-form-label">Rental
                                                    Price</label>
                                                <div class="col-md-5">
                                                    <input type="number" class="form-control amount"
                                                        id="inputPassword" placeholder="$0.00">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputPassword" class="col-md-7 col-form-label">Security
                                                    Deposit</label>
                                                <div class="col-md-5">
                                                    <input type="number" class="form-control amount"
                                                        id="inputPassword" placeholder="$0.00">
            ...
            <div class="col-md-12">
                ...
                <div class="modal fade property" id="buisness_property" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
