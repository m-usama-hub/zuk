...
class BusinessMessage extends Model
{
    ...
    public function CoverImages(){
        ...
        return $this->hasMany('App\Models\BusinessImage','model_record_id')->where('model','Message')->orderby('sort_order');
    }

    public function FristCoverImage(){

        return $this->hasOne('App\Models\BusinessImage','model_record_id')->where('model','Message')->orderby('sort_order');
