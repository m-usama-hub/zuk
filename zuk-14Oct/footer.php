                      ...
                      <div class="col-md-6 col-12">
                         <div class="form-group text_fields">
                            <form>
                               ...
                               <input type="email" placeholder="Add project location e.g. Brampton On" class="text">
                            </form>
                         </div>
                      </div>
                      <div class="col-md-6 col-12">
                         <div class="form-group text_fields">
                            <form>
                               <input type="number" placeholder="Private Phone" class="text">
                               <input type="text" placeholder="Address" class="text">
                            </form>
                         </div>
 ...
 <div class="modal fade property" id="buisness_property" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
       <div class="modal-content">
          <div class="modal-header">
             <div class="col-md-3 col-12"> <img src="./img/Homzs.png" alt="" class="homzs"> </div>
          ...
          <div class="modal-body">
             ...
             <div class="col-md-12 col-12">
                <div class="row ">
                   <div class="col-md-3 col-12 person"> <img src="./img/person_new.png" alt="" class="person">
                      <div class="profile">
                         <h5>Profile photo</h5>
                      </div>
                   </div>
                      ...
                      <div class="row forms">
                         ...
                         <div class="col-md-6">
                            ...
                            <form action="">
                               ...
                               <div class="form-group text_fields">
                                  <input type="number" placeholder="Contact person" class="text">
                               </div>
                            </form>
                         </div>
                      </div>
             ...
             <div class="cover_photo">
                <div class="img_background">
                   <div class="cover"> <img src="./img/FOCUS.png" alt="" class="focus_size">
                      <p>Cover Photo</p>
                   </div>
                   <div class="empty_img"> <img src="./img/empty.png" alt="" class="img-fluid"> </div>
                   <div class="trash"><i class="upload_icons fas fa-trash"></i></div>
                   <div class="upload"><i class="upload_icons fas fa-file-upload"></i></div>
                   <div class="camera"><i class="upload_icons fas fa-camera"></i></div>
                </div>
       ...
       <div class="modal-content">
          ...
          <div class="modal-body">
             ...
             <form action="">
                ...
                <input type="password" name="confirm_password" class="email" placeholder="Confirm Password">
 ...
 <footer>
       ...
       <div class="container custom_container">
          <div class="row">
             <div class="col-lg-2">
                ...
                <a class="navbar-brand footer-brand" href="index.php">
                   <img src="./img/logo.png" alt="">
               </a>

             </div>
             <div class="col-lg-2">
                <h5 class="blue">Our Bussiness</h5>
             ...
             <div class="col-lg-2">
                <h5 class="blue">Help</h5>
                <ul class="list-style text-small">
                   <li><a class="text-muted" href="#!">FAQ</a></li>
                   <li><a class="text-muted" href="#!">Support</a></li>
                   <li><a class="text-muted" href="#!">Join</a></li>
                   <li><a class="text-muted" href="#!">Support</a></li>
                   <li><a class="text-muted" href="#!">Add Your Business</a></li>
                </ul>
             </div>
             <div class="col-lg-3">
                <ul class="list-style text-small footer_three">
                   <li><a class="text-muted" type="button" data-toggle="modal" data-target="#postproject">Add A project Or Job</a></li>
                   <li><a class="text-muted" type="button" data-toggle="modal" data-target="#buisness_property">Add A Property</a></li>
                   <li><a class="text-muted" type="button" data-toggle="modal" data-target="#itemtosell">Post An Item To Sell</a></li>
                   <li><a class="text-muted" type="button" data-toggle="modal" data-target="#postmessage">Post A Message</a></li>
                   <li><a class="text-muted" type="button" data-toggle="modal" data-target="#mydetails">Post Flatmate Profile</a></li>
                </ul>
             </div>
             <div class="col-lg-3">
                <h5 class="blue">Newsletter</h5>
                <p>Sign Up to our newsletter and get lastest news and updates</p>
                <form class="footer-form">
                   <div class="form-group">
                      <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email Address">
                   </div>
                   <button type="submit" class="btn btn-link text-white subscribe_btn">Subscribe</button> <a href="#!" class="green"><i class="fab fa-instagram"></i></a> <a href="#!" class="green"><i class="fab fa-facebook-f"></i></a>
                </form>
             </div>
          </div>
       </div>
    ...
    <div class="text-center copy-right">
       <div class="custom_container">
          <p>All posted reviews or ratings on this website are
             the personal opinion of the person posting them.
             Homzs is not responsible for such reviews or ratings
             and does not endorse them. By using this site you agree
             to our Terms of Use. All information shared on this site
             is subject to our<a href="#!"> Privacy Policy</a>
          </p>
          <p>Copyrights © 2021 Homzs.com</p>
       </div>
    </div>
