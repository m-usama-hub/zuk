   ...
   <section class="multiple_popup">
      <div class="container custom_container">
         <div class="row">
                        ...
                        <div class="modal-body">
                           <div class="col-lg-12 detail-box mt-3">
                              <div class="row">
                                 ...
                                 <div class="col-lg-8 media_content">
                                    <div class="media">
                                       <img class="mr-3" src="./img/thumbnail_person.png" class="img-fluid" alt="Generic placeholder image">
                                       <div class="media-body">
                                          <h3 class="mt-0 blue">Toshiba 65 Inches 4K HD TV <span class="ab-right">$4.69</span></h3>
                                          <p class="gray"> <span class="ab-right">Collection</span> <span class="ab-right collection">Delivery</span></p>
                                    ...
                                    <div class="pr-description">
                                       <h4 class="blue">Description</h4>
                                       <p class="addReadMore showlesscontent">that I hired the above service provider and that
                                    ...
                                    <div class="web_site_views">
                                       <a href="https://www.mywebsite.ca"> <img src="./img/icon-web.png" class="img-fluid" alt=""> https://www.mywebsite.ca</a>
                                       <a href="#!" class="views">123 reviews</a>
                                    </div>
                                    <div class="contact-desc">
                                       <a href="tel: 647 985 5214"><i class="fas fa-phone-alt l-blue pr-2"></i> 647 985 5214</a> <a href="mailto:jasonelectrics@gmail.com"><i class="fas fa-envelope l-blue pl-2 pr-2"></i>jasonelectrics@gmail.com</a>
            ...
            <!-- House details end -->
            <!-- Find-A-Property starts -->
            <div class="col-md-12">
               <div class="row">
                  <div class="col-md-12">
                     <!-- Button trigger modal -->
                     <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#property_find">
                     Find a Property
                     </button>
                     <!-- Modal -->
                     <div class="modal fade" id="property_find" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content find_property_pop_up">
                              <div class="modal-body d-flex">
                                 ...
                                 <div class="col-lg-8 media_content">
                                    <div class="media">
                                       <img class="mr-3" src="./img/google-translate.png" alt="Generic placeholder image">
                                       <div class="media-body">
                                          <h3 class="mt-0 blue">2 Bedroom Basement Flat <span class="ab-right">$250,000.00</span></h3>
                                          <p class="gray">Vanguard Drive, Etobicoke ON M9B 5E7 <span class="ab-right">For Sale</span></p>
                                       </div>
                                    </div>
                                    <div class="pr-description">
                                       <ul class="smart_realtor">
                                          ...
                                          <li><i class="fas fa-bed pr-2 l-blue icons-p"></i> 3</li>
                                          <li><i class="pl-2 pr-2 fas fa-bath l-blue"></i> 1</li>
                                          <li><i class="pl-2 fas fa-cube l-blue"></i> Flat/Apartment</li>
                                       </ul>
                                    ...
                                    <div class="contact-desc0 pb-3">
                                       <a href="#"><i class="fas fa-user-alt l-blue"></i> Contact person | George Matin</a>
                                    </div>
                                    <div class="contact-desc">
                                       <a href="tel: 647 985 5214"><i class="fas fa-phone-alt l-blue pr-2"></i> 647 985 5214</a> <a href="mailto:smartrealtors@gmail.com"><i class="fas fa-envelope l-blue pl-2 pr-2"></i> smartrealtors@gmail.com</a>
            ...
            <!-- Find-a-property-modal ends -->
            <!-- find a housemate modal starts -->
            <div class="col-md-12">
               <!-- Button trigger modal -->
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#housemate_pop">
               Find a house mate
               </button>
               <!-- Modal -->
               <div class="modal fade" id="housemate_pop" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                           <div class="col-lg-12 detail-box">
                              <div class="row">
                                 ...
                                 <div class="col-lg-8 media_content">
                                    <div class="media">
                                       <img class="mr-3" src="./img/thumbnail_person.png" alt="Generic placeholder image">
                                       <div class="media-body">
                                          <h3 class="mt-0 blue">Married couple looking for a room <span class="ab-right">$1200<span class="blue per_month">month</span></span></h3>
                                          <p class=""><span class="ab-right gray">My Budget</span></p>
                                          <ul class="single_room_details">
                                             <li class="gray">Becky G </li>
                                             <li class="gray">Professional 35</li>
                                             <li class="gray">Single room</li>
                                          </ul>
                                       </div>
                                    </div>
                                    <div class="pr-description">
            ...
            <!-- Find a housemate modal ends  -->
            <!-- Find a Professional modal starts -->
            <div class="col-md-12">
               <!-- Button trigger modal -->
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#professional">
               Find a Professional
               </button>
               <!-- Modal -->
               <div class="modal fade" id="professional" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                     <div class="modal-content professional_pop_modal">
                        <div class="modal-body">
                           <div class="col-lg-12">
                              <div class="row">
                                 <div class="col-lg-4">
                                 ...
                                 <div class="col-lg-8 pf-shadow">
                                    <div class="media">
                                       <img class="mr-3" src="./img/google-translate.png" alt="Generic placeholder image">
                                       <div class="media-body">
                                          <h3 class="mt-0 blue">Jason Electricals Inc <span class="ab-right"><small><i class="fas fa-star orange"></i> 4.5/5</small></span></h3>
                                          <p class="orange mb-0">Landscaping, Stonework, Deck</p>
                                          <p>27 Vanguard Drive, Etobicoke ON M9B 5E7</p>
                                       </div>
                                    </div>
                                    <div class="pr-description pt-3">
                                       <h4 class="blue pb-2">About Us </h4>
                                       <p>that I hired the above service provider and that this review is based on my personal experience of the service I received and is my honest opinion of this company or person. I have not received any additional benefits or rewards that I hired the above service provider and that this review is based on my personal experience of the service I received and is my honest opinion of this company or person. I have not received any
                                          additional benefits or rewards for oviding
                                       </p>
                                       <div class="col-md-12 card-in-heart">
                                          <a href="#!" class="heart"><i class="far fa-heart"></i></a>
                                          <a href="#!" class="share"><i class="fas fa-share-square"></i></a>
                                    ...
                                    <div class="contact-desc">
                                       <a href="tel: 647 985 5214"><i class="fas fa-mobile-alt l-blue pr-3"></i> 647 985 5214</a> <a href="#"><i class="fas fa-window-maximize l-blue pl-2 pr-2"></i> www.jasonelectrics.ca</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
            ...
            <!-- Find a Professional modal Ends  -->
         </div>
      </div>
   </section>
   <!--FOOTER PHP INCLUDE-->
